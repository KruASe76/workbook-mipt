...
- **В ортонормированном базисе $\overline{e_{1}}, \overline{e_{2}}, \overline{e_{3}}$:**
...
### Свойства
- $(\overline{a}, \overline{b}, \overline{c}) = -(\overline{b}, \overline{a}, \overline{c})$
- $(\overline{a}, \overline{b}, \overline{c}) = (\overline{c}, \overline{a}, \overline{b})$
- **В ПДСК:**
